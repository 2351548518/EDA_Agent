...
from backend.agent.service import chat_with_agent  # 导入你的 Agent 主函数

load_dotenv()


def _extract_answer(outputs: Any) -> str:
    # print(f"Debug: Extracting answer from outputs: {outputs}")
...
evaluate(
    ...
    experiment_prefix="EDA RAG Evaluation Base3",
)