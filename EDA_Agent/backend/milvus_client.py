...
class MilvusManager:
    ...
    def hybrid_retrieve(
        ...
        for hits in results:
            """
            Processing hit: {'id': 465135284688782832, 'distance': 0.013333333656191826, 'entity': {'parent_chunk_id': '2410.09865v3.pdf::p6::l2::12', 'chunk_level': 3, 'file_type': 'PDF', 'chunk_idx': 358, 'text': 'ping features. Quantitative results in Tab. 5 highlight the im-\npact of FAU control: FER accuracy increases from 34.62%\nto 48.74%, and FAU detection accuracy rises from 88.91%\nto 92.37%. This also translates into improved downstream\nperformance on RAF-DB and AffectNet.', 'page_number': 6, 'chunk_id': '2410.09865v3.pdf::p6::l3::28', '65v3.pdf::p6::l1::4', 'filename': '2410.09865v3.pdf'}}
            """
            for hit in hits:
